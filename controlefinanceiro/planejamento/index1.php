...
<tbody>
     ...
     <tr>
      <th scope="row">Despesa/Rendimento 2</th>
...
$idusuario = $_SESSION['usuarioId'];
    ...
    $query_cidades = "SELECT Cont.id, Cont.valor AS cont_valor,
                 
                    ContNome.nome AS ContNome_nome
                
                

                    FROM ControleFinanceiro Cont
                 
                    INNER JOIN ControleFinanceiroNome AS ContNome ON ContNome.nome = Cont.receita
                
               
                 
                
                 
                 WHERE Cont.executado = '1' && Cont.id_usuario = '$idusuario'  && Cont.datadarealizacao <= '$mes1' 
    ...
    $result_cidades = $conn->prepare($query_cidades);
    $result_cidades->execute();

    while($row_cidade = $result_cidades->fetch(PDO::FETCH_ASSOC)){        
        //var_dump($row_cidade);
        extract($row_cidade);
       // echo "ID: $id <br>";
       // echo "Nome da cidade: $cont_valor ";
       echo "<tr>";
        echo "<th  scope='row'>$ContNome_nome</th> ";
        echo "<td>$cont_valor</td>";
        echo "<tr>";
    }
    ...
    ?>
      ...
      <td width="100px"><p style="text-align: justify;"></p>Desp 1</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 2</td>
      <td width="100px"><p style="text-align: justify;"></p></td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 4</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 5</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 6</td>
      <td width="100px"><p style="text-align: justify;"></p></td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 8</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 9</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 10</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 11</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 12</td>
</tr> 
 ...
 <tr>
      ...
      <td width="100px"><p style="text-align: justify;"></p>Desp 1</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 2</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 3</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 4</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 5</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 6</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 7</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 8</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 9</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 10</td>
      <td width="100px"><p style="text-align: justify;"></p>Desp 11</td>
...
{
    document.getElementById("divprincipal1").style = "position:relative;height:420px;max-height:700px;";
...
?>
 ...
 <button id="btnexpandir" class="botao" onclick="btnExpandir()" style="visibility:;float:right; background-color:transparent;">
Expandir
</button>

 <button id="btnexpandirfechar" class="botao" onclick="btnExpandirFechar()" style="visibility:hidden;float:right; background-color:transparent;margin-top:-150px;margin-right:-80px;">
Fechar
</button>
 
<div id="divprincipal1" class="divPrincipal" align="center"  style="visibility:hidden;position:absolute;">
<div class="divsimulacao" id="divsimulacao"style="width:80%;"align="center">
...
<div style="width:1572px;float:;visibility:;" align="center">
