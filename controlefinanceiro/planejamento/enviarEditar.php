...
$up = mysql_query("UPDATE ControleFinanceiro SET receita= '$_POST[rendimento]',  despesa='$_POST[despesa]', valor= '$valor1', vencimento='$_POST[vencimento]',  executado= '$exec',simulado= '$simu', datadarealizacao='$_POST[datadarealizacao] ', valorRealizado='$valorRealizado', id='$_POST[id]' WHERE id='$_POST[id]' && id_usuario= '$_POST[id_usuario]'");
