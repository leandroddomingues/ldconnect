...
Expandir
 ...
 <button id="btnexpandirfechar" class="botao" onclick="btnExpandirFechar()" style="visibility:hidden;float:right; background-color:transparent;margin-top:-210px;margin-right:-80px;">
Fechar
</button>
