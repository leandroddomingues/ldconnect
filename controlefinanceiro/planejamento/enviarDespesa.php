...
$sql="INSERT INTO ControleFinanceiro (despesa, valor  , vencimento, datadarealizacao, valorRealizado, executado, id_usuario, simulado)
VALUES
('$_POST[despesa]','$valor1' * -1,'$vencimento','$dataDeRealizacao','$valorRealizado' *-1,'$exec1','$_POST[id_usuario]', '$simu')";
...
//echo $_POST['valor'];//"1 registro inserido.     ";
