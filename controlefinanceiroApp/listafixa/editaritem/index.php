...
<form style="margin-left:center;" method="post" action="editarItem.php">
         ...
         Categoria atual: <br>
         <input style="width:80%;text-align:center;"name="categoria" type="text" id="categoria" placeholder="Categoria*" value="'.$result1['categoria'].'">
      <input name="idusuario" style="position:absolute;"type="hidden" id="idusuario" placeholder="Id usuario*" value="'.$result1['id_usuario'].'"><br>
     
       Item: <br>
       <input style="width:80%;text-align:center;"name="item" type="text" id="item" placeholder="Item*" value="'.$result1['item'].'"><br>
       Quantidade: <br>
       <input style="width:40%;text-align:center;" name="quantidade"type="number" id="quantidade" placeholder="Quantidade"  value="'.$result1['quantidadefixa'].'"><br>
         Valor unitário: <br>
         <input style="width:80%;text-align:center;"name="valor_unitario"type="money" id="valor_unitario" placeholder="Valor unitário*"  value="'.$result1['valor_unitariofixo'].'"><br>
        <input style="position:absolute;"name="valor_total"type="hidden" id="valor_total" placeholder="Valor total*"  value="'.$result1['valor_totalfixo'].'"><br>
        <input style="position:absolute;"name="id"type="hidden" id="id"   value="'.$result1['id'].'" >
...
<input style="position:absolute;"type="hidden" name="id" value="'.$result1["id"].'">	
