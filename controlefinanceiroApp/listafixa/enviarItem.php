...
$sql="INSERT INTO ListaDeCompras (item_avulso, item, id_usuario  , categoria, valor_unitariofixo, quantidadefixa)
VALUES
('$_POST[avulso]', '$_POST[item]','$_POST[id_usuario]','$_POST[categoria]','$_POST[valor_unitario]','$_POST[quantidade]')";
