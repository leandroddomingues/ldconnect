...
$sql="INSERT INTO ControleFinanceiro (despesa, valor  , vencimento, datadarealizacao, valorRealizado, executado, id_usuario)
VALUES
('$_POST[despesa]','$valor1' * -1,'$_POST[vencimento]','$_POST[dataDeRealizacao]','$valorRealizado'*-1,'$exec1','$_POST[id_usuario]')";
