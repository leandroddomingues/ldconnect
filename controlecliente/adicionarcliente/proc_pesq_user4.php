...
$result_user = "SELECT * FROM Controle_cliente_contato  WHERE Contrato = '$ContratoContato' && Contrato_Contato = $ContratoContato";
...
echo "</tr> ";
  ...
  //ContratoContato, Nome_contato, Email_contato, Telefone_contato, Funcao_contato,Nome_Setor, Contrato
	  ...
	  // 	echo "<td width='250px'><p style='text-align:center;'> ".$row_user['Contrato']."</p></td>";
	   	echo "<td width='400px'><p style='text-align:center;'>".$row_user['Nome_Contato']."</p></td>";
	   	echo "<td width='100px'><p style='text-align:center;'>".$row_user['Email_contato']."</p></td>";
	   	echo "<td width='100px'><p style='text-align:center;'>".$row_user['Telefone_contato']."</p></td>";
	   	echo "<td width='100px'><p style='text-align:center;'>".$row_user['Funcao_contato']."</p></td>";
	   echo "<td width='100px'><p style='text-align:center;'>".$row_user['Nome_Setor']."</p></td>";
...
//	   	echo "<td width='250px'><p style='text-align:center;'> ".$row_user54['Contrato']."</p></td>";
	...
	echo "<strong>Adicione um contato!</strong>";
}
...
//	    echo "<p style='color: green;'>Carregado os dados com sucesso!</p>";
	    ...
	    echo "<strong style=\"color:red;\">Adicione um contato!</strong>";
	}
}
