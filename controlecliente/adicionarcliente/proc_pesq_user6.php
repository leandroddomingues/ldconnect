...
//echo "<tr>";
     ...
     //      <td width="50%">Maçã</td>
       //     <td>Alface</td>
         //   <td>Arroz</td>
        //</tr>(window.location= './inicio')
   echo "<strong style=\"color:red;\">Este cliente já está cadastrado!</strong><br>
  <button class= \"botao\"style='width:100px;' onclick=\"EditarCliente()\">Editar cliente</button><br>
<script>
